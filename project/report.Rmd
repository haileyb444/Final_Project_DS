...
**EDIT**
Embarking on the univariate exploration of the SleepStudy dataframe marks the commencement of a nuanced journey into the intricate realm of sleep patterns among the surveyed individuals. As we initiate this phase of analysis, our focus turns to individual variables, with the goal of comprehensively understanding their distributions, trends, and inherent characteristics. In this exploration, each variable becomes a narrative thread, and the spotlight now shines on unraveling the singular story encapsulated within the data. The initial stages of univariate exploration promise to unveil essential insights into the fundamental aspects of sleep study, setting the stage for a more profound understanding of the intricate dynamics that shape sleep-related behaviors within our dataset.
...
SleepStudy %>% 
  ...
  labs(x = "", 
       ...
       title = "Distribution of Sleep Quality Among College Students")
```
...
SleepStudy %>% 
  ...
  labs(x = "",
       y = "Sleep Quality",
       caption = "Data Source: SleepStudy dataframe",
       title = "Sleep Quality Aggregated by Gender Among College Students")
```
...
SleepStudy %>% 
  ...
  labs(x = "",
       y = "Sleep Quality",
       caption = "Data Source: SleepStudy dataframe",
       title = "Sleep Quality Aggregated by Class Year Among College Students")
```
...
SleepStudy %>% 
  ...
  labs(x = "",
       y = "Sleep Quality",
       caption = "Data Source: SleepStudy dataframe",
       title = "Sleep Quality Aggregated by Sleep Habits Among College Students")
```
...
SleepStudy %>% 
  ...
  labs(x = "",
       y = "Sleep Quality",
       caption = "Data Source: SleepStudy dataframe",
       title = "Sleep Quality Aggregated by Depression Status Among College Students")
```
...
ggplot(SleepStudy, aes(x = DepressionScore, y = PoorSleepQuality, color = DepressionStatus)) +
  ...
  labs(x = "Depression Score",
       ...
       caption = "Data Source: SleepStudy dataframe",
       title = "Depression Relavent to Sleep Quality")
```
...
SleepStudy %>% 
  ...
  labs(x = "",
       y = "Sleep Quality",
       caption = "Data Source: SleepStudy dataframe",
       title = "Sleep Quality Aggregated by Anxiety Status Among College Students")
...
ggplot(SleepStudy, aes(x = AnxietyScore, y = PoorSleepQuality, color = AnxietyStatus)) +
  ...
  labs(x = "Anxiety Score",
       ...
       caption = "Data Source: SleepStudy dataframe",
       title = "Anxiety Relavent to Sleep Quality")
```
...
SleepStudy %>% 
  ...
  labs(x = "",
       y = "Sleep Quality",
       caption = "Data Source: SleepStudy dataframe",
       title = "Sleep Quality Aggregated by Stress Level Among College Students")
```
...
ggplot(SleepStudy, aes(x = StressScore, y = PoorSleepQuality, color = Stress)) +
  ...
  labs(x = "Stress Score",
       ...
       color ="Stress Level",
       caption = "Data Source: SleepStudy dataframe",
       title = "Stess Relavent to Sleep Quality")
```
...
AlcoholUse_Refined %>% 
  ...
  labs(x = "", 
       y = "Sleep Quality", 
       title = "Sleep Quality by GPA Aggregated by Alcohol Use") 
...
ggplot(AlcoholUse_Refined, aes(x = Drinks, y = PoorSleepQuality, color = AlcoholUse_Refined)) +
  ...
  labs(x = "Alcoholic Beverages Consumed (per week)",
       ...
       caption = "Data Source: SleepStudy dataframe",
       title = "Alcohol Consumption Relavent to Sleep Quality")
```
...
ggplot(AlcoholUse_Refined, aes(x = GPA, y = PoorSleepQuality)) +
  ...
  labs(x = "GPA",
       y = "Sleep Quality",
       caption = "Data Source: SleepStudy dataframe",
       title = "GPA Relavent to Sleep Quality")
```
...
ggplot(AlcoholUse_Refined, aes(x = ClassesMissed, y = PoorSleepQuality)) +
  ...
  labs(x = "Classes Missed",
       y = "Sleep Quality",
       caption = "Data Source: SleepStudy dataframe",
       title = "Quantity of Classes Missed Relavent to Sleep Quality")
```
...
SleepStudy %>% 
  ...
  labs(x = "",
       y = "Sleep Quality",
       caption = "Data Source: SleepStudy dataframe",
       title = "Sleep Quality Aggregated by Early Classes Among College Students")
```
...
SleepStudy %>% 
  ...
  labs(x = "",
       y = "Sleep Quality",
       caption = "Data Source: SleepStudy dataframe",
       title = "Sleep Quality Aggregated by All Nighters Among College Students")
```
